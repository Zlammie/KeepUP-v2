...
const billingStripeApi = require('./billing-stripe.api');
const platformBillingApi = require('./platform-billing.api');
...
const signupRequestsSuperAdminApi = require('./signup-requests-superadmin.api');
const brzPublishingApi = require('./brz-publishing.api');
...
const emailAdminApi = require('./email-admin.api');
...
router.use('/admin/billing/stripe', billingStripeApi);
router.use('/platform/billing', platformBillingApi);
...
router.use('/superadmin/signup-requests', signupRequestsSuperAdminApi);
router.use('/brz/publishing', brzPublishingApi);
...
router.use('/email', emailAdminApi);
