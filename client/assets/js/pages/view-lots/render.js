// /assets/js/pages/view-lots/render.js
...
function fmtCurrencyLocal(n) {
  const formatted = formatCurrency(n, { maxFraction: 0 });
  return formatted || '';
}
...
function priceCell(lot) {
  ...
  topSec.appendChild(el('div', 'price-value', list != null ? fmtCurrencyLocal(list) : '-'));
  wrap.appendChild(topSec);
  ...
  botSec.appendChild(el('div', 'price-value', sales != null ? fmtCurrencyLocal(sales) : '-'));
  wrap.appendChild(botSec);
